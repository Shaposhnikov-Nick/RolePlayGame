class Goblin extends FantasyCharacter implements Fighter{
    public Goblin(String characterName, int characterHealth, int characterExperience, int characterGold,
